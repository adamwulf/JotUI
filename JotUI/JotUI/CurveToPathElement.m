...
-(CGFloat) lengthOfElement{
    ...
    length = [UIBezierPath lengthOfBezier:bez withAccuracy:.1];
    return length;
}
...
//        DebugLog(@" dot at %f", distToDot);
        [UIBezierPath subdivideBezier:bez intoLeft:leftBez andRight:rightBez atLength:distToDot withAcceptableError:.1 withCache:subBezierlengthCache];
